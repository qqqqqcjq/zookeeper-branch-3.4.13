...
public class QuorumPeer extends ZooKeeperThread implements QuorumStats.Provider {
    ...
    public synchronized void start() {
        ...
        //进行领导者选举，确定当前实例的角色
        startLeaderElection();
        //QuorumPeer就是一个Thread，启动当前线程，执行run方法
        super.start();
    }
    ...
    protected Election createElectionAlgorithm(int electionAlgorithm){
        ...
        switch (electionAlgorithm) {// 0 1 2都是老版本的领导者选举算法，现在都是使用FastLeaderElection
        case 0:
        ...
        case 3:
            ...
            //负责传输投票信息的类，可以看作传输层，投票的具体逻辑可以看作应用层
            ...
            while (running) {
                ...
                case FOLLOWING:
                    ...
                    try {
                        ...
                        follower.shutdown();
                        setFollower(null);
                        //只要服务器在运行的过程中出现了异常，leader挂掉，follower连接的时候就会抛异常
                        // 就会设置LOOKING状态，然后就可以重新选举了
                        setPeerState(ServerState.LOOKING);
                    }
                    break;
                case LEADING:
