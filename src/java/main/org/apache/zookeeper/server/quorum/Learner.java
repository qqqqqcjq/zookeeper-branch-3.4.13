    ...
    protected void syncWithLeader(long newLeaderZxid) throws IOException, InterruptedException{
        ...
        synchronized (zk) {
            if (qp.getType() == Leader.DIFF) {
                ...
                //删除/回滚 比leader的最大事务id大的那一部分事务日志，
            ...
            while (self.isRunning()) {
                ...
                case Leader.COMMIT:
                    ...
                    if (!writeToTxnLog) {
                        ...
                        //需要写事务日志的话，加入packetsCommitted队列
                ...
                case Leader.UPTODATE:
                    //是UPTODATE的指令，表示需要同步的数据已经全部加入到了packetsCommitted队列，那么跳出循环，真正开始同步
                    if (isPreZAB1_0) {
                        zk.takeSnapshot();
