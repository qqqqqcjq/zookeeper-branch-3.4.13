    ...
    public void run() {
        try {
            ...
            try {
                ...
                //learner最大的事务id和leader最大的事务id是否一样，一样的话表示没有差异，不需要进行处理
                            ...
                            if (propose.packet.getZxid() <= peerLastZxid) {
                                ...
                                if (firstPacket) {
                                    ...
                                    if (prevProposalZxid < peerLastZxid) {
                                        ...
                                        //如果follower的最大事务id大于leader的最大事务id, leader发送trunc命令，follwer多的事务日志删除掉
            ...
            while (true) {
                ...
                case Leader.REVALIDATE:
                    ...
                    break;
                case Leader.REQUEST:
                    //follower和observer都会把写请求转发给leader
